...
class TopNAttention(nn.Module):
    def __init__(self, embed_dim, num_heads, top_n=64, dropout=0.1):
        super().__init__()
    ...
    def forward(self, query, key, value, **kwargs):
        ...
        q = q.view(B, L, H, self.head_dim).transpose(1, 2) # (B, H, L, D)
...
class Panno(nn.Module):
    def __init__(self, vocab_size=5, base_filters=64, input_len=10240, dropout_rate=0.2, top_n=64):
        super().__init__()
        ...
        encoder_layer.self_attn = TopNAttention(
