...
class Panno(nn.Module):
    def __init__(self, vocab_size=5, base_filters=64, input_len=10240, dropout_rate=0.2):
        super().__init__()
        ...
        self.transformer = nn.TransformerEncoder(encoder_layer, num_layers=6) #focal_96=4,muti_monots=6,muti_tair=6
